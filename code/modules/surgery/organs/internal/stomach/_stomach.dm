...
/obj/item/organ/stomach
	...
	var/hunger_modifier = 0.2 //TFN EDIT CHANGE - Original : var/hunger_modifier = 1
...
/obj/item/organ/stomach/proc/handle_hunger_slowdown(mob/living/carbon/human/human)
	...
	if(hungry >= 70)
		human.add_or_update_variable_movespeed_modifier(/datum/movespeed_modifier/hunger, multiplicative_slowdown = (hungry / 80)) //TFN EDIT CHANGE - Original = human.add_or_update_variable_movespeed_modifier(/datum/movespeed_modifier/hunger, multiplicative_slowdown = (hungry / 50))
	else
