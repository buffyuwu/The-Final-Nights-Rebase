...
readonly BASE_PULL_URL="https://api.github.com/repos/Darkpack13/SecondCity/pulls"
...
if ! git remote | grep darkpack > /dev/null; then
   git remote add darkpack https://github.com/Darkpack13/SecondCity.git
fi
